...
public class Application implements Serializable {
	...
	@Column
	@NotNull(message = "The average score of the certificate cannot be empty!")
	@Min(value = 100, message = "The average score of the certificate cannot be less than 100!")
	@Max(value = 200, message = "The average score of the certificate cannot be more than 200!")
